...
public class LeaseAgreementController {
    ...
    public Result<IPage<AgreementVo>> page(@RequestParam long current,
        ...
        IPage<AgreementVo> agreementVoIPage =leaseAgreementService.pageAgreementByQuery(page, queryVo);
    ...
    public Result<AgreementVo> getById(@RequestParam Long id) {
        AgreementVo agreementList = leaseAgreementService.getAgreementById(id);
        return Result.ok(agreementList);
    }

...
public class SystemUserController {
    ...
    public Result<IPage<SystemUserItemVo>> page(@RequestParam long current,
        ...
        IPage<SystemUserItemVo> pageModel =
    ...
    public Result<SystemUserItemVo> getById(@RequestParam Long id) {
        SystemUserItemVo systemUserItemVo = systemUserService.selectSystemUserById(id);
        return Result.ok();
    }
    ...
    public Result<Boolean> isUsernameExists(@RequestParam String username) {
        ...
        long count = systemUserService.count(systemUserWrapper);

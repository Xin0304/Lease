package com.sanjin.lease.web.admin.controller.system;
...
public class SystemPostController {
    ...
    private Result<IPage<SystemPost>> page(@RequestParam long current,
        ...
        Page<SystemPost> pageModel = systemPostService.page(page);
    ...
    public Result updateStatusByPostId(@RequestParam Long id,
        ...
        LambdaUpdateWrapper<SystemPost> systemPostWrapper =
                new LambdaUpdateWrapper<>();
        systemPostWrapper.eq(SystemPost::getId, id);
        systemPostWrapper.set(SystemPost::getStatus, status);
        systemPostService.update(systemPostWrapper);
        return Result.ok();
    }
}

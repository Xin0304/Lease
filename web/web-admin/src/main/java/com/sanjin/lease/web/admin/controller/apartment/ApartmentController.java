...
import com.sanjin.lease.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    public Result saveOrUpdate(@RequestBody ApartmentSubmitVo apartmentSubmitVo) {
        ApartmentInfo apartmentInfo = apartmentInfoService.saveOrUpdateApartment(apartmentSubmitVo);
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current,
        ...
        Page<ApartmentItemVo> result = apartmentInfoService.selectApartmentInfoPage(page,queryVo);
    ...
    public Result updateReleaseStatusById(@RequestParam Long id,
        ...
        LambdaUpdateWrapper<ApartmentInfo> infoUpdateWrapper = new LambdaUpdateWrapper<>();
        infoUpdateWrapper.eq(ApartmentInfo::getId, id);
        infoUpdateWrapper.set(ApartmentInfo::getIsRelease,status);
        return Result.ok(apartmentInfoService.update(infoUpdateWrapper));
    }
